      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
              ...
              <a href="{{ route('blog-post', $post->id)}}"><img class="card-img-top" src="{{ asset('storage/'.$post->image)}}" alt="Card image cap"></a>
                <div class="p-6 text-center">
                  <p><a class="small-5 text-lighter text-uppercase ls-2 fw-400" href="#">
                  {{ $post->categary->name }}
                  </a></p>
                  <h5 class="mb-0"><a class="text-dark" href="{{ route('blog-post', $post->id)}}">
                  {{ $post->title}}
                  </a></h5>
                </div>
              </div>
