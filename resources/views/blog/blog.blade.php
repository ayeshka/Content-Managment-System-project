...
@section('header')
 ...
 <!-- Header -->
 <header class="header text-white h-fullscreen pb-80" style="background-image: url({{ asset('storage/'.$posts->image)}});" data-overlay="9">
    <div class="container text-center">

      <div class="row h-100">
        <div class="col-lg-8 mx-auto align-self-center">

          <p class="opacity-70 text-uppercase small ls-1">{{ $posts->categary->name}}</p>
          ...
          <p><img class="avatar avatar-sm" src="https://www.pavilionweb.com/wp-content/uploads/2017/03/man-300x300.png" alt="..."></p>
